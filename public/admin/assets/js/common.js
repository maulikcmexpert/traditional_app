...
const insertAboveTask = (zone, mouseY) => {
  const els = zone.querySelectorAll(".scrumb-inner-content:not(.is-dragging)");
...
$(document).ready(function () {
  ...
  $(".add-newvariation-btn").on("click", function (e) {
      ...
      $(".edit-product-variation .product-category-select").append(newVariation);
  });

  // Delete variation
  $(".edit-product-variation .product-category-select").on("click", ".delete-variation", function (e) {
      e.preventDefault();
...
function createTag() {
  ...
  tags.slice().reverse().forEach((tag,ind) => {
...
let per = document.getElementById("kt_ecommerce_add_product_discount_percentage");
