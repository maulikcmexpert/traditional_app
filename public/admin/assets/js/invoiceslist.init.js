    ...
    Array.from(Invoices).forEach(function (e) {
      ...
      var a =
        `<tr>
                ...
                <td class="id"><a href="invoicesdetail.php" " data-id="` +
        e.invoice_no +
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="invoicesdetail.php" onclick="ViewInvoice(this);" data-id="` +
        e.invoice_no +
        `" ><i class="fa-solid fa-eye"></i>
                                    View</a></li>

                            <li><a class="dropdown-item" href="invoicescreate.php" onclick="EditInvoice(this);" data-id="` +
        e.invoice_no +
        `"><i class="fa-solid fa-pen"></i>
                                    Edit</a></li>

                            <li><a class="dropdown-item" href="javascript:void(0);"><i class="fa-solid fa-download"></i>
                                    Download</a></li>
