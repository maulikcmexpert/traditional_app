$(function () {
	...
	var options = {
		series: [{
			name: 'Current',
			data: [31, 40, 68, 31, 92, 55, 100, 70, 25, 58, 22, 10]
		}, {
			name: 'Previous',
			data: [11, 82, 45, 80, 34, 52, 41, 20, 35, 75, 48, 55]
		}],
		chart: {
			foreColor: '#9ba7b2',
			height: 360,
	...
	// ----------visitors-chart----------------
	var chart = new ApexCharts(document.querySelector("#Visitors-charts"), options);
	chart.render();
	...
	var options = {
		...
		colors: ["rgba(48, 79, 253, 0.85)", "rgba(223, 226, 230, 0.25)", "#FF965D"],
		stroke: {
			width: [0, 2, 5],
			curve: 'smooth'
		},
	...
	var options = {
		series: [{
			name: 'Series A',
			data: [94, 55, 57, 56, 61, 58, 63, 60, 66, 52, 53, 41]
		}, {
			name: 'Series B',
			data: [76, 85, 101, 98, 87, 105, 91, 114, 94, 85, 101, 98,]
		}, {
			name: 'Series C',
	...
	var chart = new ApexCharts(document.querySelector("#monthly-earning-chart-2"), options);
	chart.render();
	...
	var chart = new ApexCharts(document.querySelector("#monthly-earning-chart"), options);
	chart.render();
