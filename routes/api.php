...
Route::group(['namespace' => 'Api', 'prefix' => 'v2'], function () {
    ...
    Route::get('exercise_list', [UsersController_v2::class, 'ExerciseList']);
    Route::get('eating_habit_list', [UsersController_v2::class, 'EatingHabitList']);
    ...
    Route::post('store_profilere', [UsersController_v2::class, 'storeProfilere'])->middleware('check_user');
    ...
    Route::get('get_user_connection_list', [UsersController_v2::class, 'getUserConnectionList']);
