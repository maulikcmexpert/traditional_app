...
class UserValidate extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'mobile_number' => ['required', 'numeric', new MobileNumberValidation, 'unique:users,mobile_number'],
    ...
    public function messages()
    {
        return [
            ...
            'mobile_number.unique' => 'User with this mobile number is already registered',
