    ...
    public function showUserProfile(Request $request)
    {
        try {
            ...
            if ($user_id) {
                ...
                }, 'user_interest_and_hobby', 'user_interest_and_hobby.interest_and_hobby', 'userdetail.religon', 'userdetail.zodiac_sign', 'userdetail.state', 'country', 'userdetail.organization'])->where('id', $user_id)->first();
                dd($user);
