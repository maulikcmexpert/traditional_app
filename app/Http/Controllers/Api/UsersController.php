...
class UsersController extends BaseController
{
    ...
    public function organizationProfileId(Request $request)
    {
        try {
            ...
            $user = User::with('userdetail', 'organizationdetail', 'organizationdetail.state', 'organizationdetail.city', 'organizationdetail.size_of_organization', 'country')->where('id', $request->user_id)->first();
            dd($user);
            $user_id = $this->user->id;
            $full_name = ($this->user->full_name != "") ? $this->user->full_name : "";
            $mobile_number = ($this->user->mobile_number != "") ? $this->user->mobile_number : "";
