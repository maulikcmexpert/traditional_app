        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form method="POST" id="exercise" action="{{ route('exercise.store')}}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-xxl-6 col-md-6 mb-2">
                                    <div class="w-100 d-flex align-items-end gap-2">
                                        <div class="w-100 mb-2 position-relative">
                                            ...
                                            <span class="text-danger"> @if ($errors->has('exercise*')){{ str_replace('.0','',$errors->first('exercise*')) }} @endif</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
