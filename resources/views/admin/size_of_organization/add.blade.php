        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form method="POST" id="sizeoforganization" action="{{ route('sizeoforganization.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group AddMoreForm">
                            <div class="row" id="size_of_organization">
                                <div class="col-xxl-6 col-md-6 mb-2">
                                    <div class="w-100 d-flex align-items-end gap-2">
                                        <div class="w-100 position-relative">
                                            ...
                                            <span class="text-danger"> @if ($errors->has('size_range*')){{ str_replace('.0','',$errors->first('size_range*')) }} @endif</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
