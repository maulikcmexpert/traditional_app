<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#addMore', function() {
            ...
            $("#eating_habits").append(addMoreData);
        });
        ...
        $('#add').click(function(e) {
                ...
                if (thatVal === '') {
                    ...
                    var promise = new Promise(function(resolve, reject) {
                        $.ajax({
                            ...
                            dataType: 'Json',
                            type: "POST",
                            url: "{{route('eating_habit.exist')}}",
                            data: {
                                eating_habit: thatVal
                            },
                            success: function(output) {
                                if (output == false) {
                                    that.next('.text-danger').text('Eating Habit already exist');
                                    isValid = false;
                                    resolve(false);
                                } else {
            ...
            Promise.all(promises).then(function(results) {
                if (results.includes(false)) {
                    ...
                    console.log("Duplicate Eating Habit found");
                } else if (results.includes(true)) {
                    // If all results are true, submit the form
                    console.log("No duplicate Eating Habit, submitting form");
                    $("#eating_habit").submit();
                }
        ...
        }, 'Please enter valid Eating Habit');
            ...
            rules: {
                eating_habit: {
                    ...
                    remote: {
                        ...
                        method: "POST",
                        data: {
                            eating_habit: function() {
                                return $("input[name='eating_habit']").val();
                            },
                            id: function() {
        ...
        $(document).on("click", "#delete", function(event) {
            ...
            $.ajax({
                ...
                method: "post",
                url: "{{route('eating_habit.selectedbyuser')}}",
                data: {
        ...
        if (sessionStorage.getItem('showSuccessNotification')) {
            ...
            toastr.success("Eating Habit deleted successfully!");
