        ...
        <div class="card pb-3">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form method="POST" id="culture" action="{{ route('culture.update',encrypt($getData->id))}}">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <div class="row gy-4 align-items-end">
                                <div class="col-xxl-6 col-md-6 position-relative">
                                    ...
                                    <input type="text" value="{{$getData->culture}}" class="form-control culture" name="culture" />
