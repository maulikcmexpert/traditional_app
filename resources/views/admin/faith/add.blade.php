    ...
    <div class="header-breadcrumb form-main-wrp">
        ...
        <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('faith.index')}}">Faith</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form method="POST" id="faith" action="{{ route('faith.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group AddMoreForm">
                            <div class="row" id="faiths">
                                <div class="col-xxl-6 col-md-6 mb-2">
                                    <div class="w-100 d-flex align-items-end gap-2">
                                        <div class="w-100 mb-2 position-relative">
                                            ...
                                            <span class="text-danger"> @if ($errors->has('faith*')){{ str_replace('.0','',$errors->first('faith*')) }} @endif</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
