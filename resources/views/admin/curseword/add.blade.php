    ...
    <div class="header-breadcrumb form-main-wrp">
        ...
        <nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('curseword.index')}}">Curse Word</a></li>
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form method="POST" id="curseword" action="{{ route('curseword.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="text-center"><input type="button" id="add" class="btn btn-primary submitButton" value="Add Curse Word"></div>
