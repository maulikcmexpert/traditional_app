...
<script src="{{asset('admin/assets/plugins/%40fullcalendar/timegrid/main.min.js')}}"></script>
<script src="{{asset('admin/assets/plugins/%40fullcalendar/interaction/main.min.js')}}"></script>

<script src="{{asset('admin/assets/js/calendar.init.js')}}"></script>
